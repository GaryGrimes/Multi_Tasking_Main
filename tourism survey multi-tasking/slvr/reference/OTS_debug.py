...
#             res = solver.path_penalty(path_obs, _path, DistMatrix)
...
# debug中
SCORES = [6.546162160076944e-06, 1.5858954373553838e-05, 1.791076859544893e-05, 1.4428350964154472e-05,
          1.2681865598677504e-05, 1.8423138530265e-05, 1.9820928956103915e-05, 1.0239080987442269e-05,
          1.564499694395899e-05, 1.2697955249094351e-05]
memo_parameter.extend(s)
memo_penalty.extend(10 * [-999999])
...
for itr in range(2):  # debug
    ...
    print('para_record: {}'.format(para_record))
    ...
    s_kakunin = [[-0.15935079281291667, -0.2392587596852932, 0.044838800992814454, 0.30931614995758644],
